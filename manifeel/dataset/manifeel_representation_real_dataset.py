    ...
    def _sample_to_data(self, sample):     
        ...
        for key in self.rgb_keys:
            if key in self.shape_meta['obs']:
                ...
                # image data [0, 1], (horizon, 3, 256, 256)
                obs_dict[key] = np.moveaxis(resized_image_seq, -1, 1) / 225.0
        ...
        # C,H,W to H,W,C
        # left_tactile_camera_taxim, tactile_image
        # print(' shape before:', obs_dict['tactile_image'].shape)
        resized_image = obs_dict['tactile_image'][0].transpose(1, 2, 0)
