...
import copy
from manifeel.dataset.manifeel_representation_real_dataset import ManifeelRepresentationDataset
...
class TrainVqvaeRepresentationWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        human_demonstrations_img = ManifeelRepresentationDataset(**cfg.dataset)
